...
export const ProfitCalculator: React.FC = () => {
  ...
  return (
    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 items-stretch gap-8'>
      <section className="py-24 bg-white flex flex-col h-full" id="express">
      ...
      <section className="py-24 bg-white flex flex-col h-full" id="cafe">
        <div className="max-w-7xl mx-auto px-4 flex-1 flex flex-col">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="bg-stone-50 rounded-3xl p-8 border border-stone-200 hover:shadow-xl transition-all mb-12 h-full flex flex-col"
          >
            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center mb-6 shadow-sm">
              <Building2 className="text-blue-600" />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">CAFÉ FORMAT</h3>
            <div className="space-y-4">
              <div>
                <p className="text-sm text-gray-500 mb-1">Investment:</p>
