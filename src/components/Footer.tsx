...
export const Footer = () => {
  return (
    <footer className="relative text-white md:mb-0 mb-16">
      ...
      <div className="z-0 absolute top-0 right-0 left-0 bg-black/50 w-full h-full pointer-events-none"></div>
     
      {/* Main Footer Content */}
      <div className="relative z-0 max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-10 space ">
        ...
        <div className="md:mt-0 mt-6">
          ...
          <ul className="space-y-3 text-sm text-white hover:text-green-400 transition font-bold">
      ...
      {/* Bottom Bar */}
      <div className="relative z-0 bg-[#0b2e1c]/90 text-center text-sm py-4 text-gray-200">
