        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="flex items-center gap-3 text-gray-700">
              ...
              <span className="text-lg font-semibold">Ghansoli, Navi Mumbai</span>
            </div>
            <p className="text-gray-600 text-lg">
              Just a realistic example of consistent, sustainable operations. This outlet demonstrates how the 3-brand model works in
              practice.
            </p>
          </motion.div>
